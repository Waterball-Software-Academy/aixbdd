...
Identity mapping only: every `<table_name>` maps to itself. See SOP.md.
...
_AIBDD_CORE_LIB = (
    _THIS_FILE.parents[3] / "aibdd-core" / "scripts" / "lib"
)
...
def _format_yaml(table_names: list[str]) -> str:
    header = "# DO NOT EDIT — generated by aibdd-dsl-to-isa-interpretation/01-table-to-entity\n"
    if not table_names:
