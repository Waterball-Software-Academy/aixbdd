...
定義於 `aibdd-core/assets/boundaries/web-frontend/step-classification.yml::routes`（11 條，分 Tier-1 / Tier-2）；每個 handler 之 plan-time 履約見 `aibdd-core/assets/boundaries/web-frontend/plugin-contract.md`。
...
- machine routing SSOT：`.claude/skills/aibdd-core/assets/boundaries/web-frontend/step-classification.yml`
- per-handler plan-time 履約：`.claude/skills/aibdd-core/assets/boundaries/web-frontend/plugin-contract.md`
